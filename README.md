...
> 📘 **Database Setup:** For complete Neo4j installation, Bolt configuration, and APOC plugin setup, see [Module 6: Neo4j Installation & Setup Guide](#module-6-neo4j-installation--setup-guide) below.
