...
# ==========================================
# COMMENTED OUT VISION MODELS (FFmpeg Bypass)
# ==========================================
# Query
# INPUT_PATH="dataset/query"

# OUTPUT_PATH="eval/features/query/qwen3"
# CUDA_VISIBLE_DEVICES=${CUDA_DEVICES[0]} python preprocess/extract_query_feats_qwen3.py --input-path "$INPUT_PATH" --output-path "$OUTPUT_PATH"

# OUTPUT_PATH="eval/features/query/vlm2vec"
# CUDA_VISIBLE_DEVICES=${CUDA_DEVICES[0]} python preprocess/extract_query_feats_vlm2vec.py --input-path "$INPUT_PATH" --output-path "$OUTPUT_PATH"
# ==========================================
...
# FIX 3: Commented out Image, Clip, and Video since we haven't downloaded them yet
